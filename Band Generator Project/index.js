...
app.post("/submit", (req, res) => {
  ...
  let Adj_index = Math.floor(Math.random() * adj.length);
  let noun_index = Math.floor(Math.random() * noun.length);

  let rand_ADJ = adj[Adj_index];
  let rand_Noun = noun[noun_index];

  res.render("index.ejs", {adjective: rand_ADJ, noun: rand_Noun});
